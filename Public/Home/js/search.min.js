$(function () {
    $(window).resize(function () {
        ...
        var c, d, e;
        b && $("#spcInput").val(b), c = $.trim($("#search_input").val()), ("请输入职位名称，如：产品经理" == c || "请输入公司名称，如：拉勾" == c) && (c = ""), d = /[\\\/]/g, e = c.replace(d, " "), e = encodeURIComponent(e), $("#labelWords").val(""), "" == e ? $("#searchForm").attr("action", ctx + "/jobs/list_所有职位").submit() : $("#searchForm").attr("action", ctx).submit()
