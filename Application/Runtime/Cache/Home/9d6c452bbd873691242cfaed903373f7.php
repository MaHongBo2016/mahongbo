...
<head>
    ...
    <title><?php echo ($data['name']); ?>-<?php echo ($data['short_name']); ?>-招招网-最专业的互联网招聘平台</title>
    ...
    <script src="/Public/Home/js/jquery-hbzx.js" type="text/javascript"></script>
    <!--[if lte IE 8]>
    ...
    <div id="container">
        <div class="clearfix">
            <div class="content_l">
                <dl class="job_detail">
                    <dt>
                    <h1 title="<?php echo ($data['name']); ?>">
                        <em></em>
                        <div><?php echo ($data['short_name']); echo ($data['branch']); ?>招聘</div>
                        <?php echo ($data['name']); ?>
                    </h1>
                    ...
                    <dd class="job_request">
                        ...
                        <span>工作经验: <?php echo ($data['work_year']); ?> </span>
                        <span>学历: <?php echo ($data['edu']); ?></span>
                        <span><?php echo ($data['nature']); ?></span><br/>
                        职位诱惑 : <?php echo ($data['welfare']); ?>
                        <div>发布时间：<?php echo (date('Y-m-d',$data['create_time'] )); ?></div>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                        <p>岗位职责： <?php echo ($data['desc']); ?></p>
                    </dd>
                    ...
                    <div class="saoma saoma_btm">
                        <div class="dropdown_menu">
                            <div class="drop_l">
                                <img src="/Public/Home/images/job_qr_btm.png" width="131" height="131"/>
                            </div>
                            <div class="drop_r">
            ...
            <div class="content_r">
                <dl class="job_company">
                    <dt>
                        <a href="h/c/683.html" target="_blank">
                            <img class="b2" src="<?php echo ($data['logo']); ?>" width="80"
                                 height="80" alt="<?php echo ($data['cname']); ?>"/>
                            <div>
                                <h2 class="fl">
                                    <?php echo ($data['short_name']); ?>

                                    <img src="/Public/Home/images/valid.png" width="15" height="19" alt="拉勾认证企业"/>
                    ...
                    <dd>
                        <ul class="c_feature reset">
                            <li><span>领域</span> <?php echo ($data['trade']); ?></li>
                            <li><span>规模</span> <?php echo ($data['num']); ?></li>
                            <li>
                                <span>主页</span>
                                <a href="http://L99.com" target="_blank" title="<?php echo ($data['web']); ?>" rel="nofollow"><?php echo ($data['web']); ?></a>
                            </li>
                        </ul>

                        <h4>发展阶段</h4>
                        <ul class="c_feature reset">
                            <li><span>目前阶段</span> <?php echo ($data['stage_name']); ?></li>
                        </ul>

                        <h4>公司标签</h4>
                        <ul class="company_tags reset" id="hasLabels">
                            <?php if(is_array($data['tag'])): $i = 0; $__LIST__ = $data['tag'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><?php echo ($vo["name"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <a href="h/subject/s_zhouyou.html?utm_source=BD__lagou&utm_medium=&utm_campaign=zhouyou" target="_blank"
                   class="eventAd">
                    <img src="/Public/Home/images/zhouyou.jpg" width="280" height="135"/>
                </a>
            </div>
        </div>
        ...
        <div style="display:none;">
            ...
            <div id="uploadFile" class="popup">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center"><img src="/Public/Home/images/loading.gif" width="55" height="16"
