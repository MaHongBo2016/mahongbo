        ...
        <div class="clearfix">
            <div class="content_l">
                <form id="companyListForm" name="companyListForm" method="get" action="">
                    <input type="text" name="keyword" tabindex="1" value="<?php echo ($choice["keyword"]); ?>"
                           placeholder="请输入公司名称，如：招招" style="height: 58px; padding-bottom: 2px; padding-top: 2px;"/>
                    <input type="hidden" id="city" name="city" value=""/>
                    <input type="hidden" id="fs" name="stage" value=""/>
                    <input type="hidden" id="ifs" name="trade" value=""/>
                    ...
                    <dl class="hc_tag">
                        ...
                        <ul class="workplace reset fr" id="workplaceSelect">
                            <div class="greybg <?php echo ($search_c["all"]); ?>" id="selected" style="width: 643px;">
                                <div>已选择</div>
                                <ul class="reset">
                                    <?php if($choice["keyword"] == null): ?><style>
                                            .keyword_show {
                                                display: none
                                            }
                                        </style><?php endif; ?>
                                    <?php if($choice["city"] == null): ?><style>
                                            .city_show {
                                                display: none
                                            }
                                        </style><?php endif; ?>
                                    <?php if($choice["stage"] == null): ?><style>
                                            .stage_show {
                                                display: none
                                            }
                                        </style><?php endif; ?>
                                    <?php if($choice["trade"] == null): ?><style>
                                            .trade_show {
                                                display: none
                                            }
                                        </style><?php endif; ?>

                                    <li class="keyword_show" style="width: 220px"><span><strong>关键字</strong>：<?php echo ($choice["keyword"]); ?></span><a
                                            href="http://www.zhaozhao.com/index.php/Search/com_index.html?keyword=clean&city=&stage=&trade="><span
                                            class="select_remove"></span></a></li>
                                    <li class="city_show" style="width: 220px"><span><strong>所在城市</strong>：<?php echo ($choice["city"]); ?></span><a
                                            href="http://www.zhaozhao.com/index.php/Search/com_index.html?keyword=&city=clean&stage=&trade="><span
                                            class="select_remove"></span></a></li>
                                    <li class="stage_show" style="width: 220px"><span><strong>发展阶段</strong>：<?php echo ($choice["stage"]); ?></span><a
                                            href="http://www.zhaozhao.com/index.php/Search/com_index.html?keyword=&city=&stage=clean&trade="><span
                                            class="select_remove"></span></a></li>
                                    <li class="trade_show" style="width: 220px"><span><strong>行业领域</strong>：<?php echo ($choice["trade"]); ?></span><a
                                            href="http://www.zhaozhao.com/index.php/Search/com_index.html?keyword=&city=&stage=&trade=clean"><span
                                            class="select_remove"></span></a></li>
                                </ul>
                            </div>
                    ...
                    <iframe src="<?php echo U('company_search');?>" frameborder="0" width="700px" height="1550px" scrolling="no" align="up"></iframe>
                </form>
            </div>
            <div class="content_r">
