...
<head>
    <script async="" src="/Public/Home/js/analytics.js"></script>
    ...
    <script type="text/javascript" src="/Public/Home/js/jquery-hbzx.js"></script>
    <!--[if lte IE 8]>
...
<div id="body">
                        ...
                        <div class="dropdown_menu">
                            <div class="drop_l">
                                <img width="131" height="131"
                                     src="/Public/Home/images/73338ca8e1694b298d223745670f8daf_318969.jpg">
                                <span>[仅限本人使用]</span>
                            </div>
                            <div class="drop_r">
            ...
            <div class="content_r">
                    ...
                    <dt>
                        <a target="_blank" href="c/19607.html">
                            <img width="80" height="80" alt="广东国馆酒业有限公司"
                                 src="/Public/Home/images/ff80808145ae05750145b0467a1c7ddd.png" class="b2">
                            <div>
                                <h2 class="fl">
                                    国馆

                                    <img width="15" height="19" alt="拉勾认证企业" src="/Public/Home/images/valid.png">
                        ...
                        <div id="smallmap"
                                    ...
                                    <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;">
                                        <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 0px; height: 0px; -moz-user-select: none; left: 130px; top: 75px; z-index: -4625058;"
                                              unselectable="on" class="BMap_Marker"><div
                                                ...
                                                src="/Public/Home/images/marker_red_sprite.png"></div></span></div>
                            ...
                            <div style="height: 32px; position: absolute; z-index: 30; -moz-user-select: none; bottom: 0px; right: auto; top: auto; left: 1px; display: none;"
                                 class=" anchorBL"><a title="到百度地图查看此区域" target="_blank"
                                    ...
                                    src="/Public/Home/images/copyright_logo.png"
                            ...
                            <div unselectable="on" class=" BMap_cpyCtrl BMap_noprint anchorBL"
                                ...
                                <span _cid="1" style="display: inline;"><span style="font-size:11px">&copy; 2014 Baidu&nbsp;- Data &copy;
                                    <a style="display:inline;" href="http://www.navinfo.com/"
                ...
                <a class="eventAd" target="_blank"
                   href="subject/s_zhouyou.html?utm_source=BD__lagou&amp;utm_medium=&amp;utm_campaign=zhouyou">
                    <img width="280" height="135" src="/Public/Home/images/zhouyou.jpg">
                </a>
            </div>
        </div>
	...
	-->
        ...
        <script src="/Public/Home/js/job_detail.js" type="text/javascript"></script>
...
<script src="/Public/Home/js/tongji.js" type="text/javascript"></script>
<!--  -->
<script src="/Public/Home/js/analytics01.js" type="text/javascript"></script>
<script type="text/javascript" src="/Public/Home/js/h.js"></script>
<script type="text/javascript">
    $(function () {
        $('#noticeDot-1').hide();
