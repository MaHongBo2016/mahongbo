...
<script type="text/javascript" async="" src="/Public/Home/js/conversion.js"></script><script src="/Public/Home/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
				...
				<li>
					<a rel="nofollow" href="create.html">发布职位</a>
				</li>
			</ul>
        ...
        <!--form-->  
            <dl class="c_section c_section_service">
                ...
                <dd>
					...
					<form class="corp_form"   id="companyNameForm" method="post" action="<?php echo U('Home/CompanyRegist/step_2');?>">
						...
						<input type="text" value="<?php echo ($data["name"]); ?>" placeholder="请输入与公司营业执照一致的公司全称" name="name" id="companyName" class="valid ui-autocomplete-input" autocomplete="off">
	                   	<input type="submit" data-id="<?php echo ($_SESSION['user']['id']); ?>" dada-id="12" value="提 交" id="bindSubmit">

	                   	<a class="goback" href="<?php echo U('step_1');?>">返回修改邮箱地址</a>
                    </form>
...
<div class="dn" id="loadingDiv" style="display: none;">
	<img width="32" height="32" src="/Public/Home/images/ajax-loader.gif">
</div>
...
<script>
	...
	$(function(){
		$('#bindSubmit').click(function(){
			...
			var url = "/index.php/Home/CompanyRegist/ajax_del_companyname/id/"+id;
			$.get(url,{},function(e){
			},'json')
...
<div id="cboxOverlay" style="display: none;">
	...
	</div><div id="cboxTopCenter" style="float: left;">

	</div><div id="cboxTopRight" style="float: left;">

	</div>
	</div>
		<div style="clear: left;"><div id="cboxMiddleLeft" style="float: left;">

		</div><div id="cboxContent" style="float: left;">
			...
			</div></div><div id="cboxMiddleRight" style="float: left;">
			...
			</div><div id="cboxBottomRight" style="float: left;">

		</div></div></div><div style="position: absolute; width: 9999px; visibility: hidden; display: none;">

</div></div><ul class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content ui-corner-all" id="ui-id-1" tabindex="0" style="display: none; top: 356px; left: 377.5px; width: 590px;"><li class="ui-menu-item" role="presentation"><a id="ui-id-3" class="ui-corner-all" tabindex="-1">创建名为"测试公司"的新公司</a></li></ul>
</body>
</html>