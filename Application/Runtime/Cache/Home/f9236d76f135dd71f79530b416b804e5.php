...
<head>
    ...
    async = ""
    src = "/Public/Home/js/conversion.js" ></script>
...
<div id="body">
    ...
    <div id="container">
        ...
        <div style="" id="stepTip">
            <a></a>
            <img width="803" height="59" src="/Public/Home/images/tiponce.jpg">
        </div>
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    <form id="stepform" method="post" action="<?php echo U('CompanyRegist/step4Handle');?>" enctype="multipart/form-data">
                        <div class="c_text_1">基本信息为必填项，是求职者加速了解公司的窗口，认真填写吧！</div>
                        <img width="668" height="56" class="c_steps" alt="第一步" src="/Public/Home/images/step1.png">
                        <h3>公司全称 <span><?php echo ($company["name"]); ?></span></h3>

                        <h3>公司简称</h3> <!--非必填-->
                        <input type="text" placeholder="请输入公司简称，如:拉勾" value="<?php echo ($company["short_name"]); ?>" name="name" id="name" class="valid">

                        <h3>公司LOGO</h3> <!--非必填改必填-->
                        <input type="file" name="companyLogo">
                        <p style="color: red"> 尺寸：190*190px大小：小于5M</p>
                    ...
                    <object width="650" height="470"
                        ...
                        <div>
                            ...
                            <p><a href="http://www.adobe.com/go/getflashplayer"><img width="112" height="33"
                                                                                     src="/Public/Home/images/get_flash_player.gif"
        ...
        <script src="/Public/Home/js/step1.min.js" type="text/javascript"></script>
        <!--script>
        var avatar = {};
