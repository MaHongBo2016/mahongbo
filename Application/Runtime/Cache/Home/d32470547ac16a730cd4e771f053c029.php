...
<div class="login_wrapper">
	...
	<div class="login_box">
		<form id="loginForm" method="post" action="<?php echo U('regist');?>" >
			...
			<input type="text" id="email" name="username" tabindex="1" placeholder="请输入常用邮箱地址" />
		...
		<div class="login_right">
			<div>已有拉勾帐号</div>
			<a  href="<?php echo U('Login/login');?>"  class="registor_now">直接登录</a>
